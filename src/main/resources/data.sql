...
VALUES
    ...
    ('Global mission 2 - ctf','Capture the flag',timestamp '2023-03-27 01:05:00',timestamp '2023-03-30 02:05:00',true,true,null,null,1);


INSERT INTO chat_message (chat_time, is_human_global, is_zombie_global, message, game_id, player_id, squad_id)
VALUES
    (timestamp '2023-03-10 00:8:11',true,true,'global chat message 1: Hey, wazzup', 1,1,null),
    (timestamp '2023-03-10 00:9:11',true,true,'global chat message 2: yo', 1,1,null),
    (timestamp '2023-03-10 00:10:11',true,false,'human faction chat message 1: lfg', 1,1,null),
    (timestamp '2023-03-10 00:10:12',true,false,'human faction chat message 2: looking for squad', 1,1,null),
    (timestamp '2023-03-10 00:10:13',true,false,'human faction chat message 3: anyone?', 1,1,null),
    (timestamp '2023-03-10 00:10:14',false,true,'zombie faction chat message 1: lets go to front yard together', 1,5,null),
    (timestamp '2023-03-10 00:10:15',false,true,'zombie faction chat message 2: brrrains', 1,5,null),
    (timestamp '2023-03-10 00:10:16',false,true,'zombie faction chat message 3: hello', 1,6,null),
    (timestamp '2023-03-10 00:10:17',false,false,'human squad 1 chat message 1: mission 1 first?', 1,1,1),
    (timestamp '2023-03-10 00:10:18',false,false,'human squad 1 chat message 2: follow my check-in', 1,1,1),
    (timestamp '2023-03-10 00:10:19',false,false,'human squad 1 chat message 3: k', 1,2,1),
    (timestamp '2023-03-10 00:10:20',false,false,'human squad 1 chat message 4: omw', 1,2,1),
    (timestamp '2023-03-10 00:10:21',false,false,'human squad 2 chat message 1: anyone online?', 1,3,2),
    (timestamp '2023-03-10 00:10:22',false,false,'human squad 2 chat message 2: dead squad?', 1,3,2),
    (timestamp '2023-03-10 00:10:23',false,false,'human squad 2 chat message 4: Im here', 1,4,2),
    (timestamp '2023-03-10 00:10:24',false,false,'human squad 2 chat message 3: k', 1,4,2),
    (timestamp '2023-03-10 00:10:25',false,false,'zombie squad 1 chat message 1: brrains?', 1,6,3),
    (timestamp '2023-03-10 00:10:26',false,false,'zombie squad 1 chat message 2: brr', 1,6,3),
    (timestamp '2023-03-10 00:10:27',false,false,'zombie squad 1 chat message 3: brrrainsss', 1,6,3),
    (timestamp '2023-03-10 00:10:28',false,false,'zombie squad 1 chat message 4: hunnggry', 1,6,3),
    (timestamp '2023-03-10 00:10:29',false,false,'zombie squad 2 chat message 1: k?', 1,7,4),
    (timestamp '2023-03-10 00:10:30',false,false,'zombie squad 2 chat message 2: k', 1,7,4),
    (timestamp '2023-03-10 00:10:31',false,false,'zombie squad 2 chat message 3: kk', 1,8,4),
    (timestamp '2023-03-10 00:10:32',false,false,'zombie squad 2 chat message 4: yessir', 1,8,4),
